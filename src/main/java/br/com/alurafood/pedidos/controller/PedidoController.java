...
public class PedidoController {
        ...
        @GetMapping("/porta")
        public String retornaPortaAtual(@Value("${local.server.port}") String porta) {
            return String.format("Requisição atendida pela instância executando na porta %s", porta);
        }
}
